function [ t1, t2, tend, xarray, xcarray, dX, dXC ] = DaysimLoop( CSavg, dX, dXC, tau, t1, t2, nsteps, increment, CBTminTarget, Time, timeCSavg, plotOn )
%%%%%%%%%%%%%%%%%%%%%%%%%%% Daysimeter Loop %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if plotOn == 1;
    ...
    daysimeterLoopPlotter( timePlot, Time, dXplot, Xclock, timeCSavg, CSavg );
end
