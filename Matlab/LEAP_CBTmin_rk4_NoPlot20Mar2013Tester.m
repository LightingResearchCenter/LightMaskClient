function [onTimes , offTimes, finalX, finalXC, endTime] = LEAP_CBTmin_rk4_NoPlot20Mar2013Tester(DaysimeterDataFile,CBTminTarget,CBTminInitial,AvailStartTime,AvailEndTime,tau,maskLightLevel)
% Input arguements
...
[ onTimes, offTimes ] = PrescriptionLoopa( numOfDaysLEAP, increment, pX, pXC, maskLightLevel, tau, t1, t2, nsteps, offLightLevel, CBTminTarget, AvailStartTime, AvailEndTime, onTimes, offTimes, onCount, offCount );
