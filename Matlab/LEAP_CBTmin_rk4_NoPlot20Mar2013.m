function [onTimes , offTimes, finalX, finalXC, endTime] = LEAP_CBTmin_rk4_NoPlot20Mar2013(DaysimeterDataFile,CBTminTarget,CBTminInitial,AvailStartTime,AvailEndTime,tau,maskLightLevel)
% Input arguements
